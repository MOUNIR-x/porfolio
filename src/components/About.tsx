...
const aboutSections = [
    ...
    },
    {
        ...
        description: "Je maîtrise les technologies backend modernes et les bases de données",
        icon: <CalendarSync className='text-accent scale-150'/>
    },
    {
        id: 3,
        title: "Developpeur Full Stack",
        description: "Je crée des applications complètes du frontend au backend",
            ...
            <div className='md:ml-4 space-y-4'>
                {aboutSections.map((section)=>(
                    ...
                    bg-base-100 p-5 rounded-xl md:w-96 shadow-xl'>
                        ...
                        <div className='md:ml-4 text-center md:left'>
